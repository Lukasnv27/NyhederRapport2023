...
const getWeather = async () => {
    ...
    function createElementRain(tag, className) {
        ...
        rainElement.src = "../icons/Kia/rain.png"
        return rainElement;
    }
    // Sky ikon
    function createElemenCloud(tag, className) {
        ...
        cloudElement.src = "../icons/Kia/cloud.png"
        return cloudElement;
    }
    ...
    function createElementSunAndCloud(tag, className) {
        ...
        sunCloudElement.src = "../icons/Kia/partlyCloudy.png"
    ...
    function createElementSun(tag, className) {
        ...
        sunElement.src = "../icons/Kia/sun.png"
        return sunElement;
    }
    ...
    function createElementWind(tag, className) {
        ...
        windElement.src = "../icons/Kia/wind.png"
        return windElement;
    }
    ...
    function createElementFog(tag, className) {
        ...
        fogElement.src = "../icons/Kia/fog.png"
        return fogElement;
    }
    ...
    function createElementSnow(tag, className) {
        ...
        snowElement.src = "../icons/Kia/snow.png"
        return snowElement;
    }
    ...
    if (forecastData.days[6].icon === "rain") {
        ...
        forecastSixIconDiv.appendChild(createElementSun('img', 'sunIcon'))
